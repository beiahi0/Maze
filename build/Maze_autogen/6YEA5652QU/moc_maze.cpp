...
QT_MOC_LITERAL(1, 5, 8), // "sendMaze"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 22), // "QVector<QVector<int> >"
QT_MOC_LITERAL(4, 38, 4) // "maze"

    },
    "Maze\0sendMaze\0\0QVector<QVector<int> >\0"
    "maze"
};
...
void Maze::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Maze::*)(QVector<QVector<int>> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Maze::sendMaze)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Maze::sendMaze(QVector<QVector<int>> _t1)
{
